...
import androidx.compose.samples.crane.base.ListViewImages
...
fun CraneHomeContent(
    ...
    val pagerState =
        rememberPagerState(initialPage = CraneScreen.Camera.ordinal) { craneScreenValues.size }
...
private fun SearchContent(
    ...
    AnimatedContent(
        ...
        when (targetState) {
            CraneScreen.Camera -> FlySearchContent(
                widthSize = widthSize,
