...
import androidx.compose.samples.crane.data.ImageData
...
class MainViewModel @Inject constructor(
    ...
    val ImageInformation = MutableLiveData<String>()
    ...
    private val _images = mutableStateOf<List<ApiService.ApiResponse>>(emptyList())
    val images: State<List<ApiService.ApiResponse>> = _images
    ...
    private fun fetchImages() {
        viewModelScope.launch(defaultDispatcher) {
            // Simulate fetching images from the repository
            val fetchedImages = destinationsRepository.fetchImages()
